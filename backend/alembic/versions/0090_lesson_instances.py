...
def upgrade() -> None:
    ...
    if not has_table:
        op.create_table(
            ...
            sa.Column("schedule_id", sa.Integer, sa.ForeignKey("group_schedules.id"), nullable=True),
            ...
            sa.Column("moved_from_id", sa.Integer, sa.ForeignKey("lesson_instances.id"), nullable=True),
