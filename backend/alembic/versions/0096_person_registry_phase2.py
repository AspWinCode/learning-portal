...
def upgrade():
    ...
    op.create_index("ix_persons_full_name", "persons", ["full_name"], unique=False, if_not_exists=True)
    op.create_index("ix_persons_email", "persons", ["email"], unique=False, if_not_exists=True)
    op.create_index("ix_persons_phone_normalized", "persons", ["phone_normalized"], unique=False, if_not_exists=True)
    op.create_index("ix_persons_role_hint", "persons", ["role_hint"], unique=False, if_not_exists=True)
    ...
    op.create_index("ix_users_person_id", "users", ["person_id"], unique=False, if_not_exists=True)
    op.create_index("ix_leads_person_id", "leads", ["person_id"], unique=False, if_not_exists=True)
    op.create_index("ix_student_cards_person_id", "student_cards", ["person_id"], unique=False, if_not_exists=True)
