...
const TrainersPage: React.FC = () => {
  ...
  const handleArchiveTrainer = async (trainerId: number, isActive: boolean) => {
    try {
      await usersApi.update(trainerId, { is_active: !isActive });
      setError('');
      await loadTrainers();
    } catch (err: any) {
                  ...
                  {isAdminLike && (
                    <TableCell>
                      <Button
                        ...
                        onClick={() => handleArchiveTrainer(trainer.id, trainer.is_active)}
                      >
