...
const IndividualLessonsQuestionnairePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await salesApi.submitIndividualLessonsQuestionnaire({
      ...
      <Container maxWidth="sm">
        <Box sx={{ py: 6 }}>
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            Анкета успешно отправлена. Менеджер свяжется с вами в ближайшее время, чтобы подобрать
            удобный формат индивидуальных занятий.
          </Typography>
        </Box>
      </Container>
    );
...
export default IndividualLessonsQuestionnairePage;
