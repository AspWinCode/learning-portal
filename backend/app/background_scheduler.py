...
from app.background_tasks import (
    ...
    task_capture_monthly_snapshots,
...
def main() -> None:
    ...
    scheduler.add_job(lambda: task_capture_monthly_snapshots.send(), "cron", day="last", hour=23, minute=50, id="capture_monthly_snapshots", max_instances=1)
