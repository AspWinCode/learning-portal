...
const CodelabStudioPage = React.lazy(() => import('./pages/CodelabStudioPage'));
        ...
        <AuthProvider>
          <ErrorBoundary>
            ...
            <Route
              path="/codelab"
              element={
                <PrivateRoute requiredPermission="codelab.access">
                  <SectionBoundary>
                    <CodelabStudioPage />
                  </SectionBoundary>
                </PrivateRoute>
            ...
            <Route
              path="/course-studio"
              element={
                <PrivateRoute requiredPermission="kodex.manage">
                  <SectionBoundary>
                    <CourseStudioPage />
                  </SectionBoundary>
                </PrivateRoute>
