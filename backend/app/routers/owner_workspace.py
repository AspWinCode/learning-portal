    ...
    if not ctx.full:
        ...
        q = q.filter(
            or_(
                ...
                exists().where(
                    and_(
                        OwnerWorkspaceMeetingUser.meeting_id == OwnerWorkspaceMeeting.id,
                ...
                exists().where(
                    and_(
                        ...
                        OwnerWorkspaceMeetingContact.contact_id.in_(visible_contact_ids),
                    )
                ) if visible_contact_ids else False,
            )
        )
    if search:
