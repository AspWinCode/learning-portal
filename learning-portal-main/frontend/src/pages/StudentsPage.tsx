                ...
                <TableRow key={parent.id}>
                  ...
                  {isAdminLike && (
                    <TableCell>
                      <Button
                        size="small"
                        color={parent.is_active ? 'secondary' : 'primary'}
                        onClick={() => handleArchiveUser(parent.id, parent.is_active, loadParents)}
                      >
                        {parent.is_active ? 'Архивировать' : 'Разархивировать'}
                      </Button>
                    </TableCell>
                  )}
                </TableRow>
                    ...
                    <TableRow key={trainer.id}>
                      ...
                      {isAdminLike && (
                        <TableCell>
                          <Button
                            size="small"
                            color={trainer.is_active ? 'secondary' : 'primary'}
                            onClick={() => handleArchiveUser(trainer.id, trainer.is_active, loadTrainers)}
                          >
                            {trainer.is_active ? 'Архивировать' : 'Разархивировать'}
                          </Button>
                        </TableCell>
                      )}
                    </TableRow>
